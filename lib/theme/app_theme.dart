...
/// A class that contains all theme configurations for the municipal complaint management application.
class AppTheme {
  AppTheme._();

  // Nepali Heritage Modern Color Palette
  static const Color primaryLight = Color(0xFFC41E3A); // Nepal flag crimson
  static const Color primaryVariantLight = Color(0xFF9A1529); // Darker crimson
  ...
  // Dark theme colors (maintaining same palette with appropriate adjustments)
  static const Color primaryDark =
  Color(0xFFE85A73); // Lighter crimson for dark mode
  static const Color primaryVariantDark = Color(0xFFC41E3A);
  static const Color secondaryDark =
  Color(0xFF4A90E2); // Lighter blue for dark mode
  static const Color secondaryVariantDark = Color(0xFF003893);
  ...
  /// Light theme optimized for municipal complaint management
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for municipal branding
    ...
    // Bottom navigation optimized for thumb-zone
    ...
    // FAB for primary actions (complaint submission)
    ...
    // Typography system for multilingual support
  ...
  /// Custom colors for complaint status indicators
  static const Color statusPending = warningLight;
  static const Color statusInProgress = Color(0xFF2196F3); // Blue
  static const Color statusCompleted = successLight;
  static const Color statusRejected = errorLight;

  /// Priority level colors
  static const Color priorityLow = Color(0xFF4CAF50); // Green
  static const Color priorityMedium = warningLight; // Amber
  static const Color priorityHigh = errorLight; // Red
  static const Color priorityCritical = Color(0xFF9C27B0); // Purple
}
